...
public class ServiceLocator extends org.apache.axis.client.Service implements services.Email.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://10.5.14.164/WebServiceForSendMailCMS/Service.asmx";
    ...
    public services.Email.ServiceSoap getServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public services.Email.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	services.Email.ServiceSoapStub _stub = new services.Email.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (services.Email.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                services.Email.ServiceSoapStub _stub = new services.Email.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }

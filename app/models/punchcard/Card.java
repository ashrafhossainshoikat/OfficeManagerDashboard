...
public class Card extends Model {
	...
	*/
	...
	public String toString() {
		return "====> \r\nCard [id=" + id + ", version=" + version + ", cardNumber=" + cardNumber + ", isBssoCard=" + isBssoCard + ", branchSolId=" + branchSolId
				+ ", isActive=" + isActive + ", isApproved=" + isApproved + ", createDate=" + createDate + ", createdBy=" + createdBy + ", lastUpdateDate="
				+ lastUpdateDate + ", lastUpdatedBy=" + lastUpdatedBy + ", customerHistoryList=" + customerHistoryList + "]\r\n";
	}
